...
- **PDF export — nested list numbering**: a nested list inside a table cell continued its parent's numbering instead of restarting at 1 per level (#107, partial). The long-word/URL-overflow-past-the-margin item in #107 remains open.
