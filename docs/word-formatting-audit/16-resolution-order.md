...
>
> **סטטוס סריקה:** ✅ נסקר במלואו &nbsp;|&nbsp; **סטטוס מימוש:** 🔄 §16.4 חלקית — הזחות תלויות‑כיוון (04) ו‑jc של טבלה (06) תוקנו, אך יישור `jc=start/end` של פסקה (קריסת טוקן `DocxAlign`) נשאר נדחה; ליבת ה‑resolution כפי שתועדה (ראו ב.3) &nbsp;|&nbsp; **עודכן לאחרונה:** 2026-06-24
